  ...
  const newsData = [
    {
      ...
      description: "Sau một thời gian giảng dạy và làm việc trong cộng đồng Pickleball, Coach Koza nhận thấy nhiều huấn luyện viên có trình độ chuyên môn tốt nhưng chưa có một giáo án bài bản cũng như phương pháp huấn luyện khoa học. Điều này không chỉ ảnh hưởng đến hiệu quả giảng dạy mà còn làm chậm sự phát triển của Pickleball tại Việt Nam.",
      image: "https://scontent.fhan14-1.fna.fbcdn.net/v/t39.30808-6/480698480_122162151770301128_2450226917495505094_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeGhi9Yjw3VMT_RBi365eTOtimCUYf7fNCWKYJRh_t80JepYlPIa6omMlhT8tGIqljqUuOSpKvGhGDV3ZPDuYtZa&_nc_ohc=CTgHqSP1XgoQ7kNvgFgz83f&_nc_oc=AdiwdqmmNBlUXuMUKjXyxgQ-GMQj5UUqrKlo6HHoqTcVDNEKnqqbQ0S4rr6ohiWsYZ8cY46iWccQVi5AtfJmS8YH&_nc_zt=23&_nc_ht=scontent.fhan14-1.fna&_nc_gid=ATpJIK6FHRvo3gVLWcDASko&oh=00_AYHhWEOoHPr5raHFnfimF__Q7DWRBtETh7y9_-CVSqAxGA&oe=67D8C569",
      link: "https://www.facebook.com/share/p/1AHAw6rybW/?mibextid=wwXIfr"
    },
    {
      category: "GIẢI ĐẤU & SỰ KIỆN",
      title: "Coach Koza Pickleball - Đại Diện & HLV Chiến Lược của Selkirk Sport",
      date: "Tháng 9 30, 2022",
      description: "Với vai trò đại diện chiến lược cho Selkirk, một trong những thương hiệu hàng đầu thế giới trong ngành Pickleball, tôi là cầu nối quan trọng giữa thương hiệu và cộng đồng thể thao Việt Nam.",
    ...
    },
    {
      ...
      description: "Pickleball đang bùng nổ tại Việt Nam với luật chơi dễ hiểu...",
      image: "https://scontent.fhan14-1.fna.fbcdn.net/v/t39.30808-6/480223842_122162204972301128_7572941456373842547_n.jpg?_nc_cat=105&ccb=1-7&_nc_sid=833d8c&_nc_eui2=AeEEZ0Dl60kr4OFEWPbCoaQpczD4hoGViBpzMPiGgZWIGrF7aElL1VFi1bc4bpZyxmAycGcvtTUoD0kaQibJwm8K&_nc_ohc=R_DgE_wevxIQ7kNvgHK3Ke6&_nc_oc=Adg9C4hlyt2u9ukCDO0JFIbOmlQplLzBw5rh8Jiq5w2iNXOIhPhL5vvnQHRoFrqkfwOMWrSFTUE-ncjn1a_vWZQq&_nc_zt=23&_nc_ht=scontent.fhan14-1.fna&_nc_gid=AgkDvozUJoAJ_UqBPbQWvBU&oh=00_AYEllLJe_pa84zkUcjqXrb8qr2rKMRAUwCPl_m_Z5GKWdQ&oe=67D8AE1A",
      link: "#"
    }
  ];
    ...
    <section className="container-section py-12 bg-gray-100">
      <div className="container mx-auto text-center">
        ...
        <p className="text-gray-800 mt-3 max-w-2xl mx-auto">
          Khám phá nguồn tin cập nhật không ngừng về Pickleball & Giải đấu quốc tế.
        </p>
